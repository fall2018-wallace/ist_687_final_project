...
plot2<-ggplot(CompOverallSat, aes(x=Airline, y=AverageCustRating)) + geom_bar(stat="identity",colour="black",fill="red") + theme(axis.text.x=element_text(angle=90,hjust=1,vjust=0.5)) 
